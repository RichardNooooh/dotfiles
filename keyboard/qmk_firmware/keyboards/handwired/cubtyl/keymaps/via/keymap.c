...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        // left hand
        KC_GRV,    KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_CYCLE_LAYERS,
        ...
        KC_CAPS,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,
                             KC_NO,    KC_LEFT,  KC_RIGHT,
                                       KC_LSFT,  KC_LCTL,  KC_LALT,  KC_LGUI,
                                                 KC_SPACE, KC_ENTER, KC_NO,
        // right hand
        KC_NO,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_EQL,
        KC_NO,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_BSLS,
        KC_NO,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
                   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  TG(_FNSYM),
                             KC_DOWN,  KC_UP,    KC_MINS,
    ...
    [_WORKMAN] = LAYOUT(
        ...
        KC_NO,     KC_Y,     KC_N,     KC_E,     KC_O,     KC_I,     KC_QUOT,
                   KC_K,     KC_L,     KC_COMM,  KC_DOT,   KC_SLSH,  TG(_FNSYM),
                             KC_DOWN,  KC_UP,    KC_MINS,
        KC_RGUI,   KC_RALT,  KC_RCTL,  KC_RSFT,
        KC_NO,     KC_DEL,   KC_BSPC
    ),
    [_FNSYM] = LAYOUT( // TODO
        ...
        _______,   KC_NO,    KC_LCBR,  KC_LBRC,  KC_LPRN,  KC_NO,    _______,
        ...
        _______,   KC_NO,    KC_RPRN,  KC_RBRC,  KC_RCBR,  _______,  _______,
